    ...
    >
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center py-24">
          <motion.div
            className="text-center lg:text-left lg:col-span-5 lg:ml-8"
          ...
          >
            ...
            >
              <motion.button
                ...
                className="bg-green-500 hover:bg-green-600 text-gray-900 font-semibold py-3 px-6 rounded-md transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 group h-[50px]"
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  to="/contact"
                  className="border-2 border-green-500 text-green-500 hover:text-gray-900 hover:bg-green-500 font-semibold py-3 px-6 rounded-md transition-all duration-300 transform flex items-center justify-center h-[50px]"
                >
                  Get In Touch
                </Link>
              </motion.div>
          ...
          <motion.div
            className="lg:col-span-7 relative flex justify-end pr-20"
            variants={itemVariants}
            style={{ y }}
          >
            <div className="flex gap-8">
              ...
              <motion.img
                ...
                alt="Robot Bumpy"
                className="w-full max-w-[800px] xl:max-w-[1000px] h-auto object-contain -ml-56"
                whileHover={{ scale: 1.1 }}
                animate={{ y: [0, 15, 0, -15, 0] }}
                transition={{
                  duration: 6,
